CREATE DATABASE IF NOT EXISTS sharemount;
USE sharemount;
...
(
    ...
    root            BIGINT UNSIGNED NOT NULL                                                                COMMENT '根文件夹主键',
    create_time     TIMESTAMP       NOT NULL    DEFAULT CURRENT_TIMESTAMP(0)                                COMMENT '创建时间',
    update_time     TIMESTAMP       NOT NULL    DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
    is_deleted      BOOLEAN         NOT NULL    DEFAULT 0                                                   COMMENT '是否删除',
...
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '用户/用户组表';
...
(
    ...
    donated         INT UNSIGNED    NOT NULL    DEFAULT 0                                                   COMMENT '用户向用户组贡献的容量大小（MB）',
...
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '用户加入用户组表';
...
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '用户存储介质表';
...
(
    ...
    CONSTRAINT      pk_id           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '用户存储介质挂载接口表';

CREATE TABLE IF NOT EXISTS storage_log
(
    id              BIGINT UNSIGNED NOT NULL                                                                COMMENT 'ID,与storage表一一对应',
    update_time     TIMESTAMP       NOT NULL    DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '最近一次尝试挂载时间',
    success         BOOLEAN         NOT NULL                                                                COMMENT '最近一次尝试挂载是否成功',
    log             TEXT            NOT NULL                                                                COMMENT '最近一次挂载日志',

    CONSTRAINT      pk_id           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '用户存储介质挂载日志表';
...
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '外围文件系统表';
...
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '挂载点表';
...
(
    ...
    CONSTRAINT      pk_id           PRIMARY KEY (id),
    INDEX           idx_parent (parent)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '符号链接表';
...
(
    ...
    CONSTRAINT      pk_id           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '符号链接路径表';
...
(
    ...
    CONSTRAINT      pk_id           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '回收站路径表';
...
(
    ...
    expire_time     TIMESTAMP                                                                               COMMENT '共享结束时间',
    create_time     TIMESTAMP       NOT NULL    DEFAULT CURRENT_TIMESTAMP(0)                                COMMENT '创建时间',
    update_time     TIMESTAMP       NOT NULL    DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
    is_deleted      BOOLEAN         NOT NULL    DEFAULT 0                                                   COMMENT '是否已取消（完成删除或被用户恢复）',
    ...
    INDEX           idx_owner (owner),
    INDEX           idx_link (link)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '链接分享表';
...
(
    ...
    CONSTRAINT      pk_id           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '链接分享路径表';
...
(
    ...
    INDEX           idx_link (link)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4 COLLATE=utf8mb4_unicode_ci                                          COMMENT '加入用户组邀请表';